...
export const getAgents = (): IAgent[] => {
    return [
        ...
        { name: "Killjoy", role: SENTINEL, imgUrl: "https://static.wikia.nocookie.net/valorant/images/6/6b/Killjoy_artwork.png/revision/latest/scale-to-width-down/679?cb=20200729134445" } as IAgent,
